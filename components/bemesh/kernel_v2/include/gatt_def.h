...
#define GATTS_MAX_CONNECTIONS 0x02 // Maximum incoming connections possible (clients)
...
#define GATTC_MAX_CONNECTIONS 0x02 // Maximum outgoing connections possible.(server)
